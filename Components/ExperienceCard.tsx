    ...
    flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929]
     p-10 opacity-40 hover:opacity-100 transition-opacity duration-200 overflow-hidden'>
      <motion.img
        ...
        viewport={{once:true}}
        src="/photo_profile.jpg" alt='Company logo' className='object-cover object-center rounded-full w-32 h-32 xl:w-[200px] xl:h-[200px]'
      />
      ...
      <div className='px-0 md:px-10'>
        ...
        <div className='flex space-x-2 my-2'>
          {/* tech used */}
          <img src="/photo_profile.jpg" alt=""  className='h-10 w-10 rounded-full'/>
          <img src="/photo_profile.jpg" alt=""  className='h-10 w-10 rounded-full'/>
          <img src="/photo_profile.jpg" alt=""  className='h-10 w-10 rounded-full'/>
        </div>
